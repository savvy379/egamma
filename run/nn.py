...
"""Script training NNs for electron PID and energy regression."""
...
def main ():
    ...
    gen_train_bkg = HDF5Generator(paths_bkg, batch_size=batch_size // 2, transform=tf.flat, endless=True)
    ...
    if torch.cuda.is_available() and num_gpus > 1:
        parallelised = multi_gpu_model(nn, num_gpus)
    else:
        parallelised = nn
        pass
